...
var CATALOG = {
  "Phone": {
    ...
    brands: {
      "Apple": [
        { n: "iPhone 17 Pro Max", repairs: { screen: { lcd: 120, oled: 250, oem: 420 }, battery: 140, backGlass: 120, chargingPort: null, rearCamera: 170, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 17 Pro", repairs: { screen: { lcd: 120, oled: 230, oem: 420 }, battery: 140, backGlass: 120, chargingPort: 160, rearCamera: 170, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 17", repairs: { screen: { lcd: 120, oled: 200, oem: 380 }, battery: 130, backGlass: 120, chargingPort: null, rearCamera: 150, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 17e", repairs: { screen: { lcd: 90, oled: 160, oem: 180 }, battery: 100, backGlass: 120, chargingPort: 120, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone Air", repairs: { screen: { lcd: null, oled: 230, oem: 380 }, battery: 130, backGlass: 120, chargingPort: 150, rearCamera: 170, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 16 Pro Max", repairs: { screen: { lcd: 110, oled: 230, oem: 400 }, battery: 120, backGlass: 120, chargingPort: 140, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 16 Pro", repairs: { screen: { lcd: 110, oled: 200, oem: 330 }, battery: 120, backGlass: 120, chargingPort: 140, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 16 Plus", repairs: { screen: { lcd: 110, oled: 180, oem: 250 }, battery: 120, backGlass: 120, chargingPort: 130, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 16", repairs: { screen: { lcd: 100, oled: 160, oem: 280 }, battery: 120, backGlass: 120, chargingPort: 120, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
        ...
        { n: "iPhone 15 Pro Max", repairs: { screen: { lcd: 110, oled: 160, oem: 300 }, battery: 120, backGlass: 120, chargingPort: 120, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 15 Pro", repairs: { screen: { lcd: 100, oled: 160, oem: 300 }, battery: 120, backGlass: 120, chargingPort: 120, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 15 Plus", repairs: { screen: { lcd: 100, oled: 160, oem: 250 }, battery: 100, backGlass: 120, chargingPort: 120, rearCamera: 120, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 15", repairs: { screen: { lcd: 100, oled: 160, oem: 250 }, battery: 100, backGlass: 120, chargingPort: 110, rearCamera: 120, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 14 Pro Max", repairs: { screen: { lcd: 110, oled: 160, oem: 300 }, battery: 120, backGlass: 120, chargingPort: 100, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 14 Pro", repairs: { screen: { lcd: 100, oled: 160, oem: 250 }, battery: 120, backGlass: 120, chargingPort: 100, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 14 Plus", repairs: { screen: { lcd: 100, oled: 150, oem: 250 }, battery: 120, backGlass: 100, chargingPort: 100, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 14", repairs: { screen: { lcd: 90, oled: 150, oem: 200 }, battery: 100, backGlass: 100, chargingPort: 100, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 13 Pro Max", repairs: { screen: { lcd: 100, oled: 160, oem: 220 }, battery: 120, backGlass: 100, chargingPort: 100, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 13 Pro", repairs: { screen: { lcd: 100, oled: 160, oem: 200 }, battery: 110, backGlass: 100, chargingPort: 100, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 13", repairs: { screen: { lcd: 90, oled: 150, oem: 170 }, battery: 110, backGlass: 90, chargingPort: 100, rearCamera: 110, waterDamage: "quote", boardRepair: "quote" } },
        ...
        { n: "iPhone 12 Pro Max", repairs: { screen: { lcd: 90, oled: 150, oem: 210 }, battery: 110, backGlass: 90, chargingPort: 90, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone 12 Pro", repairs: { screen: { lcd: 80, oled: 140, oem: 170 }, battery: 100, backGlass: 90, chargingPort: 90, rearCamera: 150, waterDamage: "quote", boardRepair: "quote" } },
        ...
        { n: "iPhone XS Max", repairs: { screen: { lcd: 80, oled: 120, oem: 150 }, battery: 80, backGlass: 80, chargingPort: 80, rearCamera: 70, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone XS", repairs: { screen: { lcd: 80, oled: 120, oem: 140 }, battery: 80, backGlass: 80, chargingPort: 80, rearCamera: 70, waterDamage: "quote", boardRepair: "quote" } },
        { n: "iPhone X", repairs: { screen: { lcd: 80, oled: 120, oem: 140 }, battery: 80, backGlass: 80, chargingPort: 80, rearCamera: 70, waterDamage: "quote", boardRepair: "quote" } },
      ...
      "Samsung": [
        ...
        { n: "Galaxy S23 Ultra", repairs: { screen: { lcd: null, oled: 180, oem: 320 }, battery: 100, backGlass: 70, chargingPort: 80, rearCamera: "quote", waterDamage: "quote", boardRepair: "quote" } },
        ...
        { n: "Galaxy S21 Ultra", repairs: { screen: { lcd: null, oled: 180, oem: 260 }, battery: 80, backGlass: 70, chargingPort: 70, rearCamera: "quote", waterDamage: "quote", boardRepair: "quote" } },
      ...
      "Google": [
        ...
        { n: "Pixel 9 Pro XL", repairs: { screen: { lcd: null, oled: 180, oem: 250 }, battery: 100, backGlass: "quote", chargingPort: "quote", rearCamera: "quote", waterDamage: "quote", boardRepair: "quote" } },
