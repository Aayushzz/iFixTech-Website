  ...
  var DEVICES = [
    {
      ...
      brands: [
        { label: "Apple", models: [
          { label: "iPhone 17 Pro Max", repairs: { screen: { lcd: 119, oled: 249, oem: 419 }, battery: 140, backGlass: 120, chargingPort: null, rearCamera: 170, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 17 Pro", repairs: { screen: { lcd: 119, oled: 229, oem: 419 }, battery: 140, backGlass: 120, chargingPort: 160, rearCamera: 170, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 17", repairs: { screen: { lcd: 119, oled: 199, oem: 379 }, battery: 130, backGlass: 120, chargingPort: null, rearCamera: 150, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 17e", repairs: { screen: { lcd: 90, oled: 159, oem: 180 }, battery: 100, backGlass: 120, chargingPort: 120, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone Air", repairs: { screen: { lcd: null, oled: 229, oem: 379 }, battery: 130, backGlass: 120, chargingPort: 150, rearCamera: 170, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 16 Pro Max", repairs: { screen: { lcd: 109, oled: 229, oem: 399 }, battery: 120, backGlass: 120, chargingPort: 140, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 16 Pro", repairs: { screen: { lcd: 109, oled: 199, oem: 329 }, battery: 120, backGlass: 120, chargingPort: 140, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 16 Plus", repairs: { screen: { lcd: 109, oled: 179, oem: 249 }, battery: 120, backGlass: 120, chargingPort: 130, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 16", repairs: { screen: { lcd: 99, oled: 159, oem: 279 }, battery: 120, backGlass: 120, chargingPort: 120, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
          ...
          { label: "iPhone 15 Pro Max", repairs: { screen: { lcd: 109, oled: 159, oem: 299 }, battery: 120, backGlass: 120, chargingPort: 120, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 15 Pro", repairs: { screen: { lcd: 99, oled: 159, oem: 299 }, battery: 120, backGlass: 120, chargingPort: 120, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 15 Plus", repairs: { screen: { lcd: 99, oled: 159, oem: 249 }, battery: 100, backGlass: 120, chargingPort: 120, rearCamera: 120, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 15", repairs: { screen: { lcd: 99, oled: 159, oem: 249 }, battery: 100, backGlass: 120, chargingPort: 110, rearCamera: 120, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 14 Pro Max", repairs: { screen: { lcd: 109, oled: 159, oem: 299 }, battery: 120, backGlass: 120, chargingPort: 100, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 14 Pro", repairs: { screen: { lcd: 99, oled: 159, oem: 249 }, battery: 120, backGlass: 120, chargingPort: 100, rearCamera: 140, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 14 Plus", repairs: { screen: { lcd: 99, oled: 149, oem: 249 }, battery: 120, backGlass: 100, chargingPort: 100, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 14", repairs: { screen: { lcd: 89, oled: 149, oem: 199 }, battery: 100, backGlass: 100, chargingPort: 100, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 13 Pro Max", repairs: { screen: { lcd: 99, oled: 159, oem: 219 }, battery: 120, backGlass: 100, chargingPort: 100, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 13 Pro", repairs: { screen: { lcd: 99, oled: 159, oem: 199 }, battery: 110, backGlass: 100, chargingPort: 100, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 13", repairs: { screen: { lcd: 89, oled: 149, oem: 169 }, battery: 110, backGlass: 90, chargingPort: 100, rearCamera: 110, waterDamage: "quote", boardRepair: "quote" } },
          ...
          { label: "iPhone 12 Pro Max", repairs: { screen: { lcd: 90, oled: 149, oem: 210 }, battery: 110, backGlass: 90, chargingPort: 90, rearCamera: 130, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone 12 Pro", repairs: { screen: { lcd: 80, oled: 139, oem: 170 }, battery: 100, backGlass: 90, chargingPort: 90, rearCamera: 150, waterDamage: "quote", boardRepair: "quote" } },
          ...
          { label: "iPhone XS Max", repairs: { screen: { lcd: 80, oled: 120, oem: 150 }, battery: 75, backGlass: 80, chargingPort: 80, rearCamera: 70, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone XS", repairs: { screen: { lcd: 80, oled: 120, oem: 140 }, battery: 75, backGlass: 80, chargingPort: 80, rearCamera: 70, waterDamage: "quote", boardRepair: "quote" } },
          { label: "iPhone X", repairs: { screen: { lcd: 80, oled: 120, oem: 140 }, battery: 75, backGlass: 80, chargingPort: 80, rearCamera: 70, waterDamage: "quote", boardRepair: "quote" } },
        ...
        { label: "Samsung", models: [
          ...
          { label: "Galaxy S23 Ultra", repairs: { screen: { lcd: null, oled: 175, oem: 320 }, battery: 100, backGlass: 70, chargingPort: 80, rearCamera: "quote", waterDamage: "quote", boardRepair: "quote" } },
          ...
          { label: "Galaxy S21 Ultra", repairs: { screen: { lcd: null, oled: 175, oem: 260 }, battery: 80, backGlass: 70, chargingPort: 70, rearCamera: "quote", waterDamage: "quote", boardRepair: "quote" } },
        ...
        { label: "Google", models: [
          ...
          { label: "Pixel 9 Pro XL", repairs: { screen: { lcd: null, oled: 175, oem: 250 }, battery: 100, backGlass: "quote", chargingPort: "quote", rearCamera: "quote", waterDamage: "quote", boardRepair: "quote" } },
